define([], function(){
    ...
    var renderDOM = function(){
        ...
        var categoryStr = '<span class="viewer-title"><a href="/tags">分类</a></span><div class="viewer-div"></div>';
        var archiveStr = '<span class="viewer-title"><a href="/archives">归档</a></span><div class="viewer-div"></div>';
        // var SearchStr = '<span class="viewer-title"><a href="javascript:;" class="popup-trigger">搜索</a></span><div class="viewer-div"></div>';
        var SearchStr = '<span class="viewer-title"><a href="javascript:;" class="popup-trigger">搜索</a></span><div class="viewer-div"></div>';
        
        
        $viewer.innerHTML = '<div id="viewer-box">\
        <div class="viewer-box-l">\
            <div class="viewer-box-wrap">'+SearchStr+archiveStr+categoryStr+aboutmeStr+friendsStr+tagStr+'</div>\
        </div>\
